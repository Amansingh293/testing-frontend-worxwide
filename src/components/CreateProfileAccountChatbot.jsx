...
const CreateProfileAccountChatbot = ({
  createProfileAccount,
  setCreateProfileAccount,
}) => {
  ...
  useEffect(() => {
    function handleClickOutside(event) {
      if (ref.current && !ref.current.contains(event.target)) {
        setCreateProfileAccount(false);
      }
    }

    if (createProfileAccount) {
  ...
  }, [createProfileAccount, setCreateProfileAccount]);
  return (
    <div className="relative w-full h-[400px]" ref={outerDiv}>
      <motion.div
        ...
        animate={{
          height: createProfileAccount ? "546px" : 0,
          opacity: createProfileAccount ? 1 : 0,
        }}
          ...
          <div className="flex flex-col gap-4 w-full h-full">
            ...
            <div className="flex gap-5 items-center w-full">
              ...
              <span className="text-[#252B37] text-[14px] font-semibold leading-[20px]">
                Let’s get started on creating an account profile!
              </span>
            </div>
            ...
            <div className="flex gap-5 items-center w-full">
              ...
              <div className="flex flex-col">
                <span className="text-[#252B37] text-[14px] font-semibold leading-[20px]">
                  What is the account name you’d like to create a profile for?
                </span>
              </div>
            </div>
...
export default CreateProfileAccountChatbot;
