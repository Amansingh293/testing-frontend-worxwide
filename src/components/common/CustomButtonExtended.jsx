...
const CustomButtonExtended = memo(
  ({ text, width, onClick, isClicked, isArrow = true, rounded }) => {
    return (
      <button
        onClick={onClick}
      ...
      >
        <div className="flex gap-1 items-center relative z-10">
          <span className="relative z-10 transition-colors duration-400 group-hover:text-white mt-1">
            {text}
          </span>
